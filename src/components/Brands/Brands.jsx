...
const Brands = () => {
  return (
    <div className="py-8 max-w-[1420px] container m-auto pt-[100px] p-[10px]">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 items-center gap-4 justify-center">
        {brands.map((brand, index) => (
          <div
            key={index}
            className="bg-white shadow-md rounded-lg p-2 flex items-center justify-center m-auto w-[214px] h-[70px]"
          >
        ...
        <a
          href="#"
          className="text-blue-500 font-semibold flex p-4 items-center rounded-lg gap-1 m-auto hover:underline w-[214px] h-[70px] bg-white shadow-md"
        >
          Все бренды →
        </a>
      </div>
